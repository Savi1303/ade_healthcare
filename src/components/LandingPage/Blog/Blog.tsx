  ...
  return (
    ...
    >
      ...
      <motion.div className="text-center mb-10" variants={itemVariants}>
        <motion.h2
          className="sm:text-lg text-lg font-bold text-blue-600"
        ...
        <motion.h3
          className="lg:text-5xl text-2xl md:w-[400px] w-[300px] lg:w-[550px] mx-auto sm:text-2xl md:text-3xl mt-3 text-gray-900"
          variants={itemVariants}
        >
          Read top articles to <span className="text-black font-extrabold">protect your health</span>
        </motion.h3>
      ...
      {/* Blog Cards Section */}
      <motion.div
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-center px-6 gap-6 mt-12"
        variants={itemVariants}
      >
        {LandingBlogPost.map((post, index) => (
          <motion.div
            ...
            className={
              index === LandingBlogPost.length - 1 && isMediumScreen
                ? 'col-span-1 md:col-span-3 md:flex md:justify-center'
                : ''
            }
            variants={itemVariants}

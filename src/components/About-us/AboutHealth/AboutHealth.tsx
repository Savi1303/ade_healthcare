...
const AboutHealth = () => {
  ...
  return (
    ...
    >
      <motion.div className="container mx-auto flex flex-col space-y-10 px-6 md:px-10" variants={itemVariants}>
        ...
        <motion.div className="flex justify-center w-full items-end flex-col lg:flex-row gap-4" variants={itemVariants}>
          {/* Left Column */}
          <motion.div className="flex flex-col items-end justify-center basis-full lg:basis-1/2 gap-4" variants={itemVariants}>
            <motion.div className="bg-[#f8e9f1] rounded-xl flex gap-4 px-6 py-7 items-center w-full md:w-2/2" variants={itemVariants} whileHover={{ scale: 1.02 }}>
              <Image
                src="/Pretty-Health Website/Images/Frame 37.png"
                alt="HIPAA COMPLIANT"
                width={60}
            ...
            <motion.div className="w-full md:w-3/4 lg:w-1/2 rounded-xl py-4 bg-[#B6B5FF] text-center flex flex-col items-center" variants={itemVariants}>
              <p className="text-sm font-bold text-gray-900 uppercase">
                Average Google Ratings
              </p>
              <div className="flex items-center space-x-2 mt-2 justify-center">

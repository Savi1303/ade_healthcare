...
const FindLocation = () => {
  return (
    <div className="md:rounded-r-full p-4 bg-white flex items-center gap-3 md:gap-4 xl:gap-6 shadow-xl w-full md:w-10/12 border-t border-t-black/20 md:border-none">

            ...
            <div className="container mx-auto flex flex-col space-y-10 px-6 md:px-10">
                ...
                <div className="text-center md:text-left">
                    ...
                    <p className="text-2xl md:text-3xl lg:text-4xl text-gray-900 font-thin mt-2 lg:w-[750px] md:w-[650px] mx-auto md:mx-0 leading-relaxed">
                        Our track record speaks for itself. Many individuals has chosen {' '}
                        <span className="text-blue-200">our medical center and have had positive, transformative experiences.</span>
                    </p>
                </div>
                ...
                <div className="mt-8 flex justify-center items-end flex-col lg:flex-row gap-4">
                    ...
                    <div className="flex flex-col items-end justify-center basis-full lg:basis-1/2 gap-4">
                        {/* Card Section */}
                        <div className="bg-[#97cad657] rounded-xl flex gap-4 p-6 items-center w-full md:w-3/4">
                            {/* Image */}
                            <Image
                            ...
                            <div className="flex flex-col space-y-3">
                                <span className='uppercase'>HIPPA COMPLAINT</span>

                                <p className="text-md text-gray-800 font-extrabold">
                                    Prettyhealth Care provides award-winning quality care.
                                </p>

                                <a
                                    href="#"
                                    className="flex items-center space-x-2 hover:text-blue-600 text-black text-md"
                                >
                                    <FaArrowRight />
                        ...
                        {/* Rating Info */}
                        <div className="w-full md:w-3/4 lg:w-1/2 rounded-xl py-4 bg-[#63c3d8e1] text-center flex flex-col items-center">
                    ...
                    <div className="w-full lg:w-1/2 space-y-6">
                        ...
                        <div className="relative w-full mx-auto">
                            <div className="overflow-hidden rounded-2xl shadow-lg space-y-10 bg-[#66a3b157] py-6 px-10 sm:px-6 md:px-16 lg:px-20">

...
function WorkProcess() {
    ...
    return (
        <div className="bg-gray-50 py-20">
            {/* Header Section */}
            <div className="px-6 sm:px-12 lg:px-40 mb-12 text-left">
                <h1 className="text-lg font-bold uppercase text-blue-600 tracking-wider">Working Process</h1>
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold lg:w-[750px]">
                    Working Process{" "}
                    <span className="font-thin">Of Our Hospital For The Patients</span>
                </h2>
                <p className="text-lg text-gray-700 mt-4 max-w-3xl text-left">

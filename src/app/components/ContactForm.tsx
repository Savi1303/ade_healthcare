    ...
    >
        ...
        <div className="group flex md:flex-row flex-col gap-[15px] md:gap-[40px]">
            <div className="form-group flex flex-col gap-[10px]">
                ...
                <input type="text" placeholder='Enter First Name' className='border border-[#5cb0dd] md:w-[250px] outline-none md:py-[5px] pl-[20px] py-[10px] rounded-[5px] placeholder:text-black placeholder:text-[12px]' />
            </div>
            <div className="form-group flex flex-col gap-[10px]">
                <label htmlFor="" className='text-[13px]'>Last Name</label>
                <input type="text" placeholder='Enter Last Name' className='border border-[#5cb0dd] md:w-[250px] outline-none md:py-[5px] pl-[20px] py-[10px] rounded-[5px] placeholder:text-black placeholder:text-[12px]' />
            </div>
        </div>
        ...
        <div className="group flex flex-col md:flex-row gap-[15px] md:gap-[40px]">
            <div className="form-group flex flex-col gap-[10px]">
                ...
                <input type="email" placeholder='Enter your Email' className='border border-[#5cb0dd] outline-none md:w-[250px] md:py-[5px] pl-[20px] py-[10px] rounded-[5px] placeholder:text-black placeholder:text-[12px]' />
            </div>
            <div className="form-group flex flex-col gap-[10px]">
                <label htmlFor="" className='text-[13px]'>Phone Number</label>
                <input type="text" placeholder='Enter Phone Number' className='border border-[#5cb0dd] outline-none md:w-[250px] md:py-[5px] pl-[20px] py-[10px] rounded-[5px] placeholder:text-black placeholder:text-[12px]' />
            </div>
        </div>

        <div className="form-group flex flex-col gap-[10px]">
            <label htmlFor="" className='text-[13px]'>Message</label>
            <textarea name="" id="" placeholder='Enter your Message' className='border border-[#5cb0dd] outline-none pl-[20px] pt-[10px]  rounded-[5px] placeholder:text-black placeholder:text-[12px]'></textarea>
        </div>
